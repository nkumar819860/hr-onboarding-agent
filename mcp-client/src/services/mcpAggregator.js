...
const getEnvironmentConfig = () => {
  ...
  return {
    ...
    assetMcpUrl: isDevelopment 
      ...
      : process.env.REACT_APP_ASSET_MCP_URL || 'https://asset-allocation-mcp-server-0etp45.rajrd4-2.usa-e1.cloudhub.io/mcp',
    notificationMcpUrl: isDevelopment 
      ? '/mcp/notification' // Proxied through nginx in Docker
      : process.env.REACT_APP_NOTIFICATION_MCP_URL || 'https://notification-mcp-server-0etp45.rajrd4-2.usa-e1.cloudhub.io/mcp'
  };
};
